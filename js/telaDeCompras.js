function escolherCorPreto() {
    document.getElementById('img-principal').src = '../images/IMAGENS-COMPRA/IPHONE14PLUSMEIANOITE.jpg';
    document.getElementById('textoTitulo').textContent = "Apple iPhone 14 Pro Max 128GB Preto 6,7” 48MP";
}
function escolherCorAzul() {
    document.getElementById('img-principal').src = '../images/IMAGENS-COMPRA/IPHONE14PLUSAZUL.jpg';
    document.getElementById('textoTitulo').textContent = "Apple iPhone 14 Pro Max 128GB Azul 6,7” 48MP";
}
function escolherCorBranco() {
    document.getElementById('img-principal').src = '../images/IMAGENS-COMPRA/IPHONE14PLUSBRANCO.jpg';
...
function escolherCorVermelho() {
    document.getElementById('img-principal').src = '../images/IMAGENS-COMPRA/IPHONE14PLUSRED.jpg';
